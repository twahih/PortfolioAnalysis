...
#Path for data
dataPath = 'Data/Data_Oct2018.csv'
...
dataPathUser = 'Data/Data_Oct2018.csv'

#factorNameUser: List, defines the factors
factorNameUser= ['World Equities','US Treasuries','High Yield ','Inflation Protection','Currency Protection']
